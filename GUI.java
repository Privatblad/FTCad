...
public class GUI extends JFrame implements
    ...
    //Denna lista sparar de ritade objekten, så de inte försvinner när ett nytt objekt ritas
	...
	pane.setLayout(new FlowLayout());	//Sätter Layout för knapparna i panelen
	setVisible(true);
    }
